...
public abstract class SupportFragment extends Fragment implements ISupportFragment, ISwipeBackFragment {
    ...
    public void onHiddenChanged(boolean hidden) {
        ...
        mBackDelegate.onHiddenChanged(hidden);
    }
    ...
    public View attachToSwipeBack(View view) {
        return mBackDelegate.attachToSwipeBack(view);
    }
    ...
    public void setParallaxOffset(@FloatRange(from = 0.0f, to = 1.0f) float offset) {
        mBackDelegate.setParallaxOffset(offset);
    }
