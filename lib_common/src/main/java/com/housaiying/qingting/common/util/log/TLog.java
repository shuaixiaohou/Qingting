package com.housaiying.qingting.common.util.log;
 ...
 * <ol>
 * <li>use TLog.d(),you could print whether the method execute,and the default tag is current class's name</li>
 * <li>use TLog.d(msg),you could print log as before,and you could location the method with a click in Android Studio Logcat</li>
 * <li>use TLog.json(),you could print json string with well format automatic</li>
 * </ol>
 *
 * @author zhaokaiqiang
...
public final class TLog {
    ...
    private static void printStackTrace() {
        ...
        for (String trace : traceString) {
            if (trace.contains("at com.socks.library.TLog")) {
                continue;
            }
