...
public class BatchDownloadActivity extends Activity implements IXmDownloadTrackCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final ProgressDialog pro = new ProgressDialog(BatchDownloadActivity.this);

                XmDownloadManager.getInstance().downloadTracks(new ArrayList<Long>(checkTrackMap.keySet()), new IDoSomethingProgress<AddDownloadException>() {
                    @Override
                    public void begin() {
                        pro.show();
                    }
        ...
        downloadTrackAdapter = new BatchDownloadTrackAdapter(BatchDownloadActivity.this, null);
        listView.setAdapter(downloadTrackAdapter);

        findViewById(R.id.button1).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(BatchDownloadActivity.this, DownloadActivity.class));
            }
        });
    ...
    private void loadData() {
        ...
        map.put("album_id", "2716928");
        map.put("page", ++mPageId + "");
        map.put("count", 50 + "");
        CommonRequest.getTracks(map, new IDataCallBack<TrackList>() {
            @Override
            public void onSuccess(TrackList object) {
                BatchDownloadActivity.this.rankTrackList = object;
