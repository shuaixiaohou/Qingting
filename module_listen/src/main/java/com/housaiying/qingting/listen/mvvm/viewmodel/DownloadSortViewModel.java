 ...
 * Description:
 */
public class DownloadSortViewModel extends BaseViewModel<QingTingModel> {

    private SingleLiveEvent<List<Track>> mTracksEvent;

    public DownloadSortViewModel(@NonNull Application application, QingTingModel model) {
